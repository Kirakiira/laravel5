...
<html>
  <head>
    <title>Salarié - Boîte à idée</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge"/>
    <meta http-equiv="content-type" content="text/html; charset=utf-8"/>
    <meta name="apple-mobile-web-app-capable" content="yes"/>
    <link href="resources/css/axure_rp_page.css" type="text/css" rel="stylesheet"/>
    <link href="data/styles.css" type="text/css" rel="stylesheet"/>
    <link href="files/salari__-_bo_te___id_e/styles.css" type="text/css" rel="stylesheet"/>
    <script src="resources/scripts/jquery-1.7.1.min.js"></script>
    <script src="resources/scripts/jquery-ui-1.8.10.custom.min.js"></script>
    <script src="resources/scripts/prototypePre.js"></script>
    <script src="data/document.js"></script>
    <script src="resources/scripts/prototypePost.js"></script>
    <script src="files/salari__-_bo_te___id_e/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u443" class="ax_default flow_shape">
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u446" class="ax_default link_button">
      ...
      <div id="u447" class="ax_default image">
        <img id="u447_img" class="img " src="images/accueil/u1.jpg"/>
      </div>

      <!-- Unnamed (Rectangle) -->
      <div id="u448" class="ax_default heading_1">
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u450" class="ax_default heading_1">
        <div id="u450_div" class=""></div>
        <div id="u450_text" class="text ">
          <p><span>Boîte à idées</span></p>
        </div>
      </div>
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u452" class="ax_default heading_2">
      ...
      <!-- Unnamed (Text Area) -->
      <div id="u453" class="ax_default text_area">
        <textarea id="u453_input"></textarea>
      </div>
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u455" class="ax_default heading_1">
        <div id="u455_div" class=""></div>
        <div id="u455_text" class="text ">
          <p><span>Les idées</span></p>
        </div>
      </div>
      ...
      <!-- Unnamed (Shape) -->
      <div id="u458" class="ax_default icon">
        <img id="u458_img" class="img " src="images/bo_te___id_e/u426.png"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u459" class="ax_default text_field">
        <input id="u459_input" type="text" value="1"/>
      </div>

      <!-- Unnamed (Shape) -->
      <div id="u460" class="ax_default icon">
        <img id="u460_img" class="img " src="images/bo_te___id_e/u426.png"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u461" class="ax_default text_field">
        <input id="u461_input" type="text" value="1"/>
      </div>
      ...
      <!-- Unnamed (Shape) -->
      <div id="u464" class="ax_default icon">
        <img id="u464_img" class="img " src="images/bo_te___id_e/u426.png"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u465" class="ax_default text_field">
        <input id="u465_input" type="text" value="1"/>
      </div>

      <!-- Unnamed (Shape) -->
      <div id="u466" class="ax_default icon">
        <img id="u466_img" class="img " src="images/bo_te___id_e/u426.png"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u467" class="ax_default text_field">
        <input id="u467_input" type="text" value="1"/>
      </div>

      <!-- Unnamed (Rectangle) -->
      <div id="u468" class="ax_default paragraph">
      ...
      <div id="u469" class="ax_default icon">
        <img id="u469_img" class="img " src="images/bo_te___id_e/u426.png"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u470" class="ax_default text_field">
        <input id="u470_input" type="text" value="1"/>
      </div>
      ...
      <div id="u472" class="ax_default icon">
        <img id="u472_img" class="img " src="images/bo_te___id_e/u426.png"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u473" class="ax_default text_field">
        <input id="u473_input" type="text" value="1"/>
      </div>

      <!-- Unnamed (Rectangle) -->
      <div id="u474" class="ax_default button">

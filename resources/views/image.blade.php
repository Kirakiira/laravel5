...
<html>
  <head>
    ...
    <link href="files/image/styles.css" type="text/css" rel="stylesheet"/>
    <script src="resources/scripts/jquery-1.7.1.min.js"></script>
    <script src="resources/scripts/jquery-ui-1.8.10.custom.min.js"></script>
    <script src="resources/scripts/prototypePre.js"></script>
    <script src="data/document.js"></script>
    <script src="resources/scripts/prototypePost.js"></script>
    <script src="files/image/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u163" class="ax_default link_button">
      ...
      <div id="u164" class="ax_default image">
        <img id="u164_img" class="img " src="images/accueil/u1.jpg"/>
      </div>
      ...
      <div id="u167" class="ax_default image">
        <img id="u167_img" class="img " src="images/image/u167.png"/>
      </div>

      <!-- Unnamed (Shape) -->
      <div id="u168" class="ax_default icon">
        <img id="u168_img" class="img " src="images/image/u168.png"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u169" class="ax_default text_field">
        <input id="u169_input" type="text" value="1"/>
      </div>
      ...
      <!-- Unnamed (Text Area) -->
      <div id="u171" class="ax_default text_area">
        <textarea id="u171_input">Commentaire</textarea>
      </div>

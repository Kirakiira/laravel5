...
<div id="base" class="">
    ...
    <div id="u6" class="ax_default icon">
        <img id="u6_img" class="img " src="/assets/image/u6.png"/>
    </div>

    <!-- Unnamed (Shape) -->
    <div id="u7" class="ax_default icon">
        <img id="u7_img" class="img " src="/assets/image/u7.png"/>
    </div>

    <!-- Unnamed (Shape) -->
    <div id="u8" class="ax_default icon">
        <img id="u8_img" class="img " src="/assets/image/u8.png"/>
    </div>
    ...
    <!-- Unnamed (Rectangle) -->
    <div id="u18" class="ax_default link_button">

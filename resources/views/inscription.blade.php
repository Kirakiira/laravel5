...
<html>
  <head>
    ...
    <link href="/assets/css/inscription.css" type="text/css" rel="stylesheet"/>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u24" class="ax_default image">
        <img id="u24_img" class="img " src="/assets/image/u1.jpg"/>
      </div>
      ...
      <div id="u38" class="ax_default heading_2">
        ...
        <div id="u38_text" class="text ">
          <p><span>Votre mot de passe doit contenir au moins une majuscule et au moins un chiffre.</span></p>
        </div>
      </div>

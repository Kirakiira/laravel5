...
<html>
  <head>
    ...
    <link href="files/mot_de_passe_perdu/styles.css" type="text/css" rel="stylesheet"/>
    <script src="resources/scripts/jquery-1.7.1.min.js"></script>
    <script src="resources/scripts/jquery-ui-1.8.10.custom.min.js"></script>
    <script src="resources/scripts/prototypePre.js"></script>
    <script src="data/document.js"></script>
    <script src="resources/scripts/prototypePost.js"></script>
    <script src="files/mot_de_passe_perdu/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u73" class="ax_default link_button">
      ...
      <div id="u75" class="ax_default image">
        <img id="u75_img" class="img " src="images/accueil/u1.jpg"/>
      </div>
      ...
      <div id="u78" class="ax_default heading_1">
        ...
        <div id="u78_text" class="text ">
          <p><span>Mot de passe oublié</span></p>
        </div>
      </div>

...
<html>
  <head>
    ...
    <link href="files/galerie_de_photo/styles.css" type="text/css" rel="stylesheet"/>
    <script src="resources/scripts/jquery-1.7.1.min.js"></script>
    <script src="resources/scripts/jquery-ui-1.8.10.custom.min.js"></script>
    <script src="resources/scripts/prototypePre.js"></script>
    <script src="data/document.js"></script>
    <script src="resources/scripts/prototypePost.js"></script>
    <script src="files/galerie_de_photo/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u124" class="ax_default image">
        <img id="u124_img" class="img " src="images/accueil/u1.jpg"/>
      </div>
      ...
      <div id="u129" class="ax_default box_1">
        <img id="u129_img" class="img " src="images/galerie_de_photo/u129.png"/>
      </div>
      ...
      <div id="u130" class="ax_default heading_1">
        ...
        <div id="u130_text" class="text ">
          <p><span>Galerie de photo</span></p>
        </div>
      </div>
      ...
      <div id="u133" class="ax_default image">
        <img id="u133_img" class="img " src="images/galerie_de_photo/u133.png"/>
      </div>
      ...
      <div id="u136" class="ax_default image">
        <img id="u136_img" class="img " src="images/galerie_de_photo/u133.png"/>
      </div>
      ...
      <div id="u139" class="ax_default image">
        <img id="u139_img" class="img " src="images/galerie_de_photo/u133.png"/>
      </div>
      ...
      <div id="u142" class="ax_default image">
        <img id="u142_img" class="img " src="images/galerie_de_photo/u133.png"/>
      </div>
      ...
      <div id="u145" class="ax_default image">
        <img id="u145_img" class="img " src="images/galerie_de_photo/u133.png"/>
      </div>
      ...
      <div id="u148" class="ax_default image">
        <img id="u148_img" class="img " src="images/galerie_de_photo/u133.png"/>
      </div>
      ...
      <div id="u151" class="ax_default image">
        <img id="u151_img" class="img " src="images/galerie_de_photo/u133.png"/>
      </div>
      ...
      <div id="u154" class="ax_default image">
        <img id="u154_img" class="img " src="images/galerie_de_photo/u133.png"/>
      </div>
      ...
      <div id="u157" class="ax_default image">
        <img id="u157_img" class="img " src="images/galerie_de_photo/u133.png"/>
      </div>

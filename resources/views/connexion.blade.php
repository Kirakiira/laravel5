...
<html>
  <head>
    ...
    <link href="/assets/css/connexion.css" type="text/css" rel="stylesheet"/>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u57" class="ax_default image">
        <img id="u57_img" class="img " src="/assets/image/u1.jpg"/>
      </div>
      ...
      <div id="u59" class="ax_default text_field">
        <input id="u59_input" type="email" value="" readonly/>
      </div>
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u65" class="ax_default link_button">
        <div id="u65_div" class=""></div>
        <div id="u65_text" class="text ">
          <p><span>Mot de passe perdu ?</span></p>
        </div>
      </div>

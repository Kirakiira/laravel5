...
<div id="base" class="">
    ...
    <!-- Unnamed (Rectangle) -->
    <div id="u203" class="ax_default link_button">
    ...
    <div id="u204" class="ax_default image">
        <img id="u204_img" class="img " src="/assets/image/u1.jpg"/>
    </div>
    ...
    <div id="u206" class="ax_default box_1">
        <img id="u206_img" class="img " src="/assets/image/u206.png"/>
    </div>

    <!-- Unnamed (Shape) -->
    <div id="u207" class="ax_default box_1">
        <img id="u207_img" class="img " src="/assets/image/u206.png"/>
    </div>

    <!-- Unnamed (Shape) -->
    <div id="u208" class="ax_default box_1">
        <img id="u208_img" class="img " src="/assets/image/u206.png"/>
    </div>

    <!-- Unnamed (Shape) -->
    <div id="u209" class="ax_default icon">
        <img id="u209_img" class="img " src="/assets/image/u209.png"/>
    </div>

    <!-- Unnamed (Shape) -->
    <div id="u210" class="ax_default icon">
        <img id="u210_img" class="img " src="/assets/image/u210.png"/>
    </div>

    <!-- Unnamed (Shape) -->
    <div id="u211" class="ax_default icon">
        <img id="u211_img" class="img " src="/assets/image/u211.png"/>
    </div>

    <!-- Unnamed (Rectangle) -->
    <div id="u212" class="ax_default heading_1">
        <div id="u212_div" class=""></div>
        <div id="u212_text" class="text ">
            <p><span>Ajouter</span></p>
        </div>
    </div>

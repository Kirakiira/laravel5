...
<html>
<head>
    <title>BDE - Menu Evenement</title>
...
<div id="base" class="">
    ...
    <!-- Unnamed (Rectangle) -->
    <div id="u188" class="ax_default flow_shape">
    ...
    <!-- Unnamed (Rectangle) -->
    <div id="u190" class="ax_default link_button">
    ...
    <div id="u195" class="ax_default heading_1">
        ...
        <div id="u195_text" class="text ">
            <p><span>Liste </span></p><p><span>des </span></p><p><span>Evenements</span></p>
        </div>
    </div>
    ...
    <div id="u198" class="ax_default heading_1">
        ...
        <div id="u198_text" class="text ">
            <p><span>Gestion </span></p><p><span>des </span></p><p><span>Evenements</span></p>
        </div>
    </div>

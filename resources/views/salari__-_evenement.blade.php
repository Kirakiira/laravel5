...
<html>
  <head>
    <title>Salarié - Evenement</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge"/>
    <meta http-equiv="content-type" content="text/html; charset=utf-8"/>
    <meta name="apple-mobile-web-app-capable" content="yes"/>
    <link href="resources/css/axure_rp_page.css" type="text/css" rel="stylesheet"/>
    <link href="data/styles.css" type="text/css" rel="stylesheet"/>
    <link href="files/salari__-_evenement/styles.css" type="text/css" rel="stylesheet"/>
    <script src="resources/scripts/jquery-1.7.1.min.js"></script>
    <script src="resources/scripts/jquery-ui-1.8.10.custom.min.js"></script>
    <script src="resources/scripts/prototypePre.js"></script>
    <script src="data/document.js"></script>
    <script src="resources/scripts/prototypePost.js"></script>
    <script src="files/salari__-_evenement/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u361" class="ax_default image">
        <img id="u361_img" class="img " src="images/accueil/u1.jpg"/>
      </div>

      <!-- Unnamed (Rectangle) -->
      <div id="u362" class="ax_default heading_1">
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u363" class="ax_default flow_shape">
        <div id="u363_div" class=""></div>
      </div>

      <!-- Unnamed (Rectangle) -->
      <div id="u364" class="ax_default link_button">
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u365" class="ax_default link_button">
      ...
      <div id="u366" class="ax_default box_1">
        <img id="u366_img" class="img " src="images/salari__-_evenement/u366.png"/>
      </div>

      <!-- Unnamed (Image) -->
      <div id="u367" class="ax_default image">
        <img id="u367_img" class="img " src="images/salari__-_evenement/u367.png"/>
      </div>
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u369" class="ax_default heading_1">
      ...
      <div id="u370" class="ax_default button">
        ...
        <div id="u370_text" class="text ">
          <p><span>Retour aux évenements</span></p>
        </div>
      </div>

      <!-- Unnamed (Placeholder) -->
      <div id="u371" class="ax_default placeholder">
        <img id="u371_img" class="img " src="images/salari__-_evenement/u371.png"/>
      </div>

      <!-- Unnamed (Shape) -->
      <div id="u372" class="ax_default icon">
        <img id="u372_img" class="img " src="images/salari__-_evenement/u372.png"/>
      </div>

      <!-- Unnamed (Shape) -->
      <div id="u373" class="ax_default icon">
        <img id="u373_img" class="img " src="images/salari__-_evenement/u373.png"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u374" class="ax_default text_field">
        <input id="u374_input" type="text" value="1"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u375" class="ax_default text_field">
        <input id="u375_input" type="text" value="1"/>
      </div>

      <!-- Unnamed (Image) -->
      <div id="u376" class="ax_default image">
        <img id="u376_img" class="img " src="images/salari__-_evenement/u376.png"/>
      </div>

      <!-- Unnamed (Image) -->
      <div id="u377" class="ax_default image">
        <img id="u377_img" class="img " src="images/salari__-_evenement/u376.png"/>
      </div>

      <!-- Unnamed (Image) -->
      <div id="u378" class="ax_default image">
        <img id="u378_img" class="img " src="images/salari__-_evenement/u376.png"/>
      </div>

      <!-- Unnamed (Rectangle) -->
      <div id="u379" class="ax_default heading_1">
        <div id="u379_div" class=""></div>
        <div id="u379_text" class="text ">
          <p><span>Commentaires</span></p>
        </div>
      </div>

      <!-- Unnamed (Text Area) -->
      <div id="u380" class="ax_default text_area">
        <textarea id="u380_input">Commentaire</textarea>
      </div>
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u382" class="ax_default button">
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u384" class="ax_default button">
